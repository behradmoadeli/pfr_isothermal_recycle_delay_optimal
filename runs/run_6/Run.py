...
guess = {
    'guess_range_real':[-350,50,200],
    'guess_range_imag':[0,200,100]
}
...
save_dataframe_to_csv(*find_eig(default_pars, default_pars=default_pars, **guess, round_sig_digits=3), 'CSV')
...
for par in pars_list:
    ...
    save_dataframe_to_csv(*find_eig(par, default_pars=default_pars, **guess, round_sig_digits=3), 'CSV')
